...
*/ var SVG = (function() {
  ...
  function getOrigin(o, element) {
    ...
    if (typeof origin === 'string' || origin == null) {
      ...
      var bx = string.includes('left')
        ? x
        : string.includes('right') ? x + width : x + width / 2;
      var by = string.includes('top')
        ? y
        : string.includes('bottom') ? y + height : y + height / 2; // Set the bounds eg : "bottom-left", "Top right", "middle" etc...
  ...
  function mockAdopt() {
    var mock =
      arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : adopt;
    adopter = mock;
  }
      ...
      if (_typeof(style) === 'object') {
        for (var _name in style) {
          ...
          this.node.style[camelCase(_name)] =
            style[_name] == null || isBlank.test(style[_name])
              ? ''
              : style[_name];
        }
      }
              ...
              if (typeof a === 'number') {
                ...
                if (isRgb.test(a)) {
                  ...
                  var _rgb$exec$slice$map = rgb
                    ...
                    _rgb$exec$slice$map2 = _slicedToArray(
                      _rgb$exec$slice$map,
                      3
                    ),
            ...
            value: function rgb() {
              if (this.space === 'rgb') {
                ...
                if (this.space === 'lab' || this.space === 'lch') {
                  ...
                  x =
                    0.95047 *
                    (Math.pow(xL, 3) > mx ? Math.pow(xL, 3) : (xL - ct) / nm);
                  y =
                    1.0 *
                    (Math.pow(yL, 3) > mx ? Math.pow(yL, 3) : (yL - ct) / nm);
                  z =
                    1.08883 *
                    (Math.pow(zL, 3) > mx ? Math.pow(zL, 3) : (zL - ct) / nm);
            ...
            value: function hsl() {
              ...
              var h = isGrey
                ...
                : max === r
                  ...
                  : max === g
                    ? ((b - r) / delta + 2) / 6
                    : max === b ? ((r - g) / delta + 4) / 6 : 0; // Construct and return the new color
        ...
        [
          ...
          },
          {
            ...
            value: function scale(x, y, cx, cy) {
              ...
              return (_this$clone = this.clone()).scaleO.apply(
                _this$clone,
                arguments
              );
            }
          ...
          },
          {
            ...
            value: function skew(x, y, cx, cy) {
              ...
              return (_this$clone2 = this.clone()).skewO.apply(
                _this$clone2,
                arguments
              );
            }
            ...
            value: function formatTransforms(o) {
              ...
              var skewX =
                o.skew && o.skew.length
                  ? o.skew[0]
                  : isFinite(o.skew) ? o.skew : isFinite(o.skewX) ? o.skewX : 0;
              var skewY =
                o.skew && o.skew.length
                  ? o.skew[1]
                  : isFinite(o.skew) ? o.skew : isFinite(o.skewY) ? o.skewY : 0;
              var scaleX =
                o.scale && o.scale.length
                  ? o.scale[0] * flipX
                  : isFinite(o.scale)
                    ? o.scale * flipX
                    : isFinite(o.scaleX) ? o.scaleX * flipX : flipX;
              var scaleY =
                o.scale && o.scale.length
                  ? o.scale[1] * flipY
                  : isFinite(o.scale)
                    ? o.scale * flipY
                    : isFinite(o.scaleY) ? o.scaleY * flipY : flipY;
              var shear = o.shear || 0;
    ...
    (function(_Base) {
      ...
      function EventTarget() {
        ...
        _this = _possibleConstructorReturn(
          this,
          _getPrototypeOf(EventTarget).call(this)
        );
        _this.events = events;
        return _this;
      }
          ...
          value: function init(value, unit) {
            ...
            if (typeof value === 'number') {
              ...
              this.value = isNaN(value)
                ? 0
                : !isFinite(value) ? (value < 0 ? -3.4e38 : +3.4e38) : value;
        ...
        },
        {
          ...
          value: function toString() {
            return (
              (this.unit === '%'
                ? ~~(this.value * 1e8) / 1e6
                : this.unit === 's' ? this.value / 1e3 : this.value) + this.unit
            );
          }
        },
        {
    ...
    (function(_EventTarget) {
      ...
      function Dom(node, attrs) {
        ...
        _this2 = _possibleConstructorReturn(
          this,
          _getPrototypeOf(Dom).call(this, node)
        );
        _this2.node = node;
  ...
  var Element =
    ...
    (function(_Dom) {
      ...
      function Element(node, attrs) {
        ...
        _this = _possibleConstructorReturn(
          this,
          _getPrototypeOf(Element).call(this, node, attrs)
      ...
      _createClass(Element, [
        ...
        },
        {
          ...
          value: function writeDataToDom() {
            ...
            return _get(
              _getPrototypeOf(Element.prototype),
              'writeDataToDom',
              this
            ).call(this);
          } // Move over x-axis
      ...
      var origin =
        direction === 'both' && isFinite(around)
          ...
          : direction === 'x'
            ...
            : direction === 'y'
              ? [0, around]
              : isFinite(direction) ? [direction, direction] : [0, 0];
      return this.transform(
        {
    ...
    (function(_Element) {
      ...
      function Shape() {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(Shape).apply(this, arguments)
        );
      }
      ...
      _createClass(Gradient, [
        ...
        },
        {
          ...
          value: function attr(a, b, c) {
            ...
            return _get(_getPrototypeOf(Gradient.prototype), 'attr', this).call(
              this,
              a,
              b,
              c
      ...
      _createClass(Pattern, [
        ...
        },
        {
          ...
          value: function attr(a, b, c) {
            ...
            return _get(_getPrototypeOf(Pattern.prototype), 'attr', this).call(
              this,
              a,
              b,
              c
  ...
  var Ease =
    ...
    (function(_Stepper) {
      ...
      function Ease(fn) {
        ...
        _this = _possibleConstructorReturn(
          this,
          _getPrototypeOf(Ease).call(this)
        );
  ...
  var Controller =
    ...
    (function(_Stepper2) {
      ...
      function Controller(fn) {
        ...
        _this2 = _possibleConstructorReturn(
          this,
          _getPrototypeOf(Controller).call(this)
        );
        _this2.stepper = fn;
        return _this2;
      }
    ...
    (function(_Controller) {
      ...
      function Spring(duration, overshoot) {
        ...
        _this3 = _possibleConstructorReturn(
          this,
          _getPrototypeOf(Spring).call(this)
        );
        ...
        },
        {
          ...
          value: function _set(value) {
            ...
            if (this._type === Color) {
              result = this._to
                ? result[this._to[4]]()
                : this._from ? result[this._from[4]]() : result;
            }
  ...
  function registerMorphableType() {
    var type =
      arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
    morphableTypes.push.apply(
      morphableTypes,
      _toConsumableArray([].concat(type))
    );
  }
      ...
      _createClass(Path, [
        ...
        },
        {
          ...
          value: function width(_width) {
            return _width == null
              ? this.bbox().width
              : this.size(_width, this.bbox().height);
          } // Set height of element
        },
        {
          key: 'height',
          value: function height(_height) {
            return _height == null
              ? this.bbox().height
              : this.size(this.bbox().width, _height);
          }
        },
        {
          key: 'targets',
  ...
  var Polyline =
    ...
    (function(_Shape) {
      ...
      function Polyline(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(Polyline).call(
            this,
            nodeOrNew('polyline', node),
            node
          )
        );
      }
  ...
  var Timeline =
    ...
    (function(_EventTarget) {
      ...
      function Timeline() {
        ...
        _this = _possibleConstructorReturn(
          this,
          _getPrototypeOf(Timeline).call(this)
        );
        ...
        _this._stepImmediate = _this._stepFn.bind(
      ...
      _createClass(Timeline, [
        ...
        },
        {
          ...
          value: function getEndTime() {
            var lastRunnerInfo = this._runners[
              this._runnerIds.indexOf(this._lastRunnerId)
            ];

            var lastDuration = lastRunnerInfo
  ...
  var Runner =
    ...
    (function(_EventTarget) {
      ...
      function Runner(options) {
        ...
        _this = _possibleConstructorReturn(
          this,
          _getPrototypeOf(Runner).call(this)
        ...
        options =
          typeof options === 'function' ? new Controller(options) : options; // Declare all of the variables
	    ...
	    */
          ...
          },
          {
	        ...
	        */
                ...
                position =
                  x <= 0
                    ? Math.round(f(1e-5))
                    : x < endTime ? f(x) : Math.round(f(endTime - 1e-5));
                return position;
          ...
          },
          {
            ...
            value: function step(dt) {
              ...
              this.done =
                !declarative && !justFinished && this._time >= duration; // Runner is running. So its not in reseted state anymore
  ...
  registerMethods({
    Element: {
      ...
      // other runners
      _clearTransformRunnersBefore: function _clearTransformRunnersBefore(
        currentRunner
      ) {
    ...
    transform: function transform(transforms, relative, affine) {
      ...
      affine =
        transforms.affine != null
          ? transforms.affine
          : affine != null ? affine : !isMatrix; // Create a morepher and set its type

      var morpher = new Morphable(this._stepper).type(
      ...
      function run(pos) {
        ...
        var _transform = new Point(origin).transform(
      ...
      _createClass(Svg, [
        ...
        },
        {
          ...
          value: function root() {
            ...
            return _get(_getPrototypeOf(Svg.prototype), 'root', this).call(
              this
            );
          } // Add namespaces
        },
        ...
        },
        {
          ...
          value: function parent(type) {
            ...
            return _get(_getPrototypeOf(Svg.prototype), 'parent', this).call(
              this,
              type
            );
          }
  ...
  var ClipPath =
    ...
    (function(_Container) {
      ...
      function ClipPath(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(ClipPath).call(
            this,
            nodeOrNew('clipPath', node),
            node
          )
        );
      ...
      _createClass(ClipPath, [
        {
          ...
          value: function remove() {
            ...
            return _get(
              _getPrototypeOf(ClipPath.prototype),
              'remove',
              this
            ).call(this);
          }
  ...
  var ForeignObject =
    ...
    (function(_Element) {
      ...
      function ForeignObject(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(ForeignObject).call(
            this,
            nodeOrNew('foreignObject', node),
            node
          )
        );
      }
      ...
      _createClass(Mask, [
        {
          ...
          value: function remove() {
            ...
            return _get(_getPrototypeOf(Mask.prototype), 'remove', this).call(
              this
            );
          }
        },
  ...
  var TextPath =
    ...
    (function(_Text) {
      ...
      function TextPath(node) {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(TextPath).call(
            this,
            nodeOrNew('textPath', node),
            node
          )
        );
